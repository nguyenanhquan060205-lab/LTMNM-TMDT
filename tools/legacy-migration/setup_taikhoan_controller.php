...
class TaiKhoanController extends Controller
{
    ...
    {
        $nd = $request->except('_token');

        if (NguoiDung::where('TaiKhoan', $nd['TaiKhoan'])
            ->orWhere('Email', $nd['Email'])
            ->orWhere('SDT', $nd['SDT'])
            ->exists()) {
...
file_put_contents(__DIR__ . '/app/Http/Controllers/TaiKhoanController.php', $content);
echo "Written TaiKhoanController";
